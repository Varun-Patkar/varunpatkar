	...
	experience: [
		{
			...
			location: "Mumbai, Maharashtra, India",
			totalPeriod: "Jul 2023 - Present (2 yrs 9 mos)",
			positions: [
				{
					title: "Software Engineer 2",
					period: "Mar 2026 - Present (1 mo)",
					description:
						"Leading a team of 3 engineers, focusing on agentic AI solutions and building intelligent agents. Pivoted from BI to AI, working with Copilot Studio, Microsoft Agent Framework, and Azure AI services to develop enterprise-grade AI agents and automation solutions.",
					technologies: ["Python", "SQL", "Azure", "Azure AI", "Copilot Studio", "Microsoft Agent Framework", "Azure OpenAI", "C#", "Agentic AI"],
				},
				{
					title: "Software Engineer 1",
					period: "Jul 2023 - Mar 2026 (2 yrs 9 mos)",
					description:
						"Worked as a full-time Software Engineer, focusing on data engineering and related technologies within the Microsoft ecosystem.",
		...
		},
		{
			...
			location: "Remote",
			totalPeriod: "May 2021 - Jun 2021 (2 mos)",
			positions: [
				{
		...
		},
		{
			...
			location: "Mumbai, Maharashtra, India",
			totalPeriod: "Sep 2020 - Jul 2022 (1 yr 11 mos)",
			positions: [
				{
					title: "Chairperson",
					period: "Jul 2021 - Jul 2022 (1 yr 1 mo)",
					description:
						"Led the college chapter of the Computer Society of India, organizing technical events, workshops, and managing team activities.",
					technologies: ["Leadership", "Event Management", "Team Coordination"],
				},
				{
					title: "Technical Executive",
					period: "Sep 2020 - Jul 2021 (11 mos)",
					description:
						"Served as Technical Executive, coordinating technical workshops and student engagement activities.",
					technologies: ["Event Coordination", "Technical Support", "Team Collaboration"],
				},
			],
		},
	],
	...
	projects: [
			{
				title: "PocketLlama",
				description:
					"A mobile app to chat with local Ollama models from your phone. Run the Python server on your PC, scan the QR code, and start chatting — with streaming responses, vision model support, conversation branching, speech-to-text via Whisper, and full local SQLite storage. Uses Azure DevTunnels for secure access with no port forwarding.",
				technologies: [
					"React Native",
					"Expo SDK 54",
					"TypeScript",
				...
				liveLink: null,
				githubLink: "https://github.com/Varun-Patkar/PocketLlama",
				youtubeLink: "https://youtu.be/e7ZsvDSIBvA",
				image:
					"https://raw.githubusercontent.com/Varun-Patkar/PocketLlama/main/mobile/assets/pocketllama-logo.png",
				squareImage: true,
			},
			{
				title: "StoryTeller",
				description:
					"A cinematic 3D web application for AI-powered interactive storytelling. Features immersive space-to-Earth camera animations, real-time narrative generation using local Ollama models, fandom-based story creation (Naruto, One Piece, Douluo Dalu, etc.), and GitHub OAuth integration. Users can create, fork, and share stories with public/private visibility controls. Frontend connects directly to Ollama with devtunnel/VM support, while Express.js backend handles MongoDB persistence and authentication.",
				technologies: [
					"React 18",
					"Vite",
					"Three.js",
				...
				liveLink: "https://story-teller-chi.vercel.app/",
				githubLink: "https://github.com/Varun-Patkar/StoryTeller",
				youtubeLink: null,
				image:
					"https://raw.githubusercontent.com/Varun-Patkar/StoryTeller/refs/heads/master/images/Story.png",
			},
			{
			title: "LocalChat",
			description:
				"A privacy-first AI chat interface for Ollama with voice input (Whisper STT), text-to-speech (Kokoro TTS), vision model support (LLaVA, Qwen-VL), intelligent web search (SearXNG), and reasoning model integration. Built as a deep dive into understanding local LLMs and AI architectures. Runs 100% locally with zero cloud dependencies.",
			technologies: [
				"React 18",
				"TypeScript",
				"Vite",
			...
			liveLink: null,
			githubLink: "https://github.com/Varun-Patkar/AI-Experiments",
			youtubeLink: "https://youtu.be/wOkEOsk_maA",
			image:
				"https://raw.githubusercontent.com/Varun-Patkar/AI-Experiments/refs/heads/main/LocalChat.png",
		},
		{
			title: "OpenForge",
			description:
				"An open-source platform for creating, managing, and interacting with AI assistants. It supports both API-based language models and in-browser WebLLM models for complete privacy.",
			technologies: [
			...
			liveLink: "https://openforge.vercel.app/",
			githubLink: "https://github.com/Varun-Patkar/openforge",
			youtubeLink: "https://youtu.be/xFzvdjYmjEE",
			image:
				"https://raw.githubusercontent.com/Varun-Patkar/openforge/refs/heads/main/public/android-chrome-512x512.png",
		},
		{
			title: "MirrorMind - Your Personal AI Companion Creator",
			description:
				"A web application that allows users to create, customize, and chat with personalized AI personas. It leverages a local WebLLM engine (Llama-3.2-3B-Instruct) to bring these personas to life, offering a unique and interactive experience directly in the browser. All data is stored locally.",
			technologies: [
				"Next.js",
				"React",
				"JavaScript",
			...
			liveLink: "https://mirrormind-varun.vercel.app/",
			githubLink: "https://github.com/Varun-Patkar/mirrormind",
			youtubeLink: "[Link to YouTube Demo Video - Placeholder]", // Replace with actual link when available
...
3.  **ELSE (IF** the user asks a general question, makes a statement, the request is ambiguous, unsupported, a scroll request was ambiguous, a specific theme request matched the current theme, **OR you are asking for contact details**):
    ...
    *   **If a scroll request was ambiguous:** Ask for clarification (e.g., "Which section? Options are: Hero, About, Skills, Projects, Experience, Education, or Contact.").
